...
public class ScriptbookService {
	...
	public void submitScriptbook(Scriptbook sb) {
		edm.addScriptbook(sb);
		edm.studentSubmitsExam(sb);
	...
	public List<MultipleAttempt> getAllMultipleAttempts(String subjectCode, String semester, String year,
...
//		MultipleQuestion(String id, String subjectCode, String year, String semester, String examType, String questionText, String ansA, String ansB, String ansC, String ansD, choice correctAnswer, int possibleMark, int answerNumber
	...
	public List<ShortAttempt> getAllShortAttempts(String subjectCode, String semester, String year, String examType,
		...
		{
			Exam exam = new Exam(subjectCode,year,semester,examType);
			edm.getShortAttempts(exam, studentNumber);
		}catch(Exception e)
		{
			e.printStackTrace();
		}
