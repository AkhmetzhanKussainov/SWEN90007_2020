...
public class CreateExam extends HttpServlet {
    ...
    /*protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String startYear=request.getParameter("start-year");
		String startMonth=request.getParameter("start-month");
		...
		String startSecond="00"; //Not obtained from form
    	
		String endYear=request.getParameter("end-year");
		String endMonth=request.getParameter("end-month");
		String endDay=request.getParameter("end-day");
		String endHour=request.getParameter("end-hour");
		String endMinute=request.getParameter("end-minute");
		String endSecond="00"; //Not obtained from form
