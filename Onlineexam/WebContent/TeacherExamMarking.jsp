...
<%
	int i =0;
        ...
        <table  style="width:90%; margin: auto;">
			...
			Mark: <input name="multiple-attempt-mark-<%=i%>" style="width: 30px;" type="number" min="0" max="<%= multiplea.getTotalMarks() %>" value="<%= multiplea.getMark() %>"/> / <%= multiplea.getTotalMarks() %></th>
...
int j =0;
        ...
        <table  style="width:90%; margin: auto;">
			...
			Mark: <input name="short-attempt-mark-<%=j%>" style="width: 30px;" type="number" min="0" max="<%= shorta.getTotalMarks() %>" value="<%= shorta.getMark() %>" /> / <%= shorta.getTotalMarks() %></th>
