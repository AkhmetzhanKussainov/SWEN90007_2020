...
<%
	int i =0;
            for (MultipleAttempt multiplea : sbs.getAllMultipleAttemptsDemo(subjectId, year, semester, examType, studentNumber)) {
       		 %>
...
<%
int j =0;
            for (ShortAttempt shorta : sbs.getAllShortAttemptsDemo(subjectId, year, semester, examType, studentNumber)) {
       		 %>
