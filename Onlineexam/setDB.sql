...
INSERT INTO exams
VALUES ('HIS101', '2020','2','F','History of Magic End of Semester Exam','T12','N', 'N', 70, '1','2');

INSERT INTO exams
VALUES ('HIS101', '2020','2','M','History of Magic End of Midsemester Exam','T12','Y', 'N', 30, '1','2');
...
INSERT INTO scriptbooks
VALUES ('HIS101', '2020','2','F',true,'S13',60,true);
...
--last boolean indicates whether its been marked
INSERT INTO multipleAttempt
VALUES (2,'HIS101', '2020','2','F','S12','A',0,false);

--last boolean indicates whether its been marked
INSERT INTO multipleAttempt
VALUES (3,'HIS101', '2020','2','F','S12','A',0,false);

--last boolean indicates whether its been marked
INSERT INTO shortAttempt
VALUES (1,'HIS101', '2020','2','F','S12','I killed Lord Voldemort',4,true);

INSERT INTO shortAttempt
VALUES (2,'HIS101', '2020','2','F','S12','Ive done it and it is weird',4,true);

INSERT INTO shortAttempt
VALUES (3,'HIS101', '2020','2','F','S12','Dodgy shops',4,true);
...
INSERT INTO multipleQuestion (questionId, subjectId, year, semester, examType, questionText, ansA, ansB, ansC, ansD, correctAnswer, possibleMarks, answerNumber)
VALUES (2,'HIS101', '2020','2','F','Thestles can be seen by whom?', 'Syltherin', 'Dementors', 'Those that have lost loved one', 'Teachers', 'A', 2, 2);

INSERT INTO multipleQuestion (questionId, subjectId, year, semester, examType, questionText, ansA, ansB, ansC, ansD, correctAnswer, possibleMarks, answerNumber)
VALUES (3,'HIS101', '2020','2','F','What kind of plant screams?', 'Oak tree', 'Mandrake plant', 'Griffin', 'Potato', 'B', 2, 2);
...
INSERT INTO multipleQuestion (questionId, subjectId, year, semester, examType, questionText, ansA, ansB, ansC, ansD, correctAnswer, possibleMarks, answerNumber)
VALUES (2,'DEF101', '2020','2','F','AbraCadavre is used by which kind of Wizards?', 'Elves', 'Dark Wizards', 'Griffins', 'Muggles', 'B', 2, 2);

INSERT INTO multipleQuestion (questionId, subjectId, year, semester, examType, questionText, ansA, ansB, ansC, ansD, correctAnswer, possibleMarks, answerNumber)
VALUES (3,'DEF101', '2020','2','F','Unforgivable curses should be used by', 'Wizards', 'Muggles', 'Students', 'None of the above', 'D', 2, 2);
