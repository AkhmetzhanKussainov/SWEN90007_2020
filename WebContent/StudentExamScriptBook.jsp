...
if (shortQuestionId != null){
	sq = qs.getShortQuestion(shortQuestionId, subjectId, semester, year, examType);
}
...
%>
<form method="post" action="SubmitScriptbook">
<%-- <h1><%= subject.getName()%>: <%= subject.getCode()%></h1> --%>
<h1>ScriptBook for: <%= e.getExamName()%>, Year: <%= e.getYear()%>, Sem: <%= e.getSemester()%>, ExamType: <%= e.getExamType()%></h1>
...
<%
	int i =0;
        ...
        <table  style="width:90%; margin: auto;">
			...
			<input type="hidden" name="multiple-question-id-<%=i%>" value="<%= multipleq.getId() %>"/>
                </th>
...
int j =0;
        ...
        <table  style="width:90%; margin: auto;">
            ...
            <tr>
                ...
                <th >
                	<input name="short-answer-<%=j%>" style="width: 1000px;" />
                	<input type="hidden" name="short-question-id-<%=j%>" value="<%= shortq.getId() %>"/>
				</th>
                
                 <th style="width: 60px;">Mark: <%= shortq.getPossibleMark() %></th>
            </tr>       
        </table>
...
<input type="hidden" class="input" name="multipleQuestionCount" value="<%= i %>"></input>
         ...
         <input type="hidden" class="input" name="studentId" value="<%= student_obj.getStudentId() %>"></input>
</form>
