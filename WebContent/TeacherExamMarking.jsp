...
<%
	...
	System.out.println(sbs.getAllMultipleAttempts(subjectId, year, semester, examType, studentNumber));
        ...
        <table  style="width:90%; margin: auto;">
			...
			<input name="multiple-attempt-version-<%=i%>" type="hidden" value="<%= multiplea.getVersion() %>"/>
			
			<% System.out.println("Multiple mark read in"); System.out.println(multiplea.getMark());%>
...
System.out.println(sbs.getAllShortAttempts(subjectId, year, semester, examType, studentNumber).size());
        ...
        <table  style="width:90%; margin: auto;">
            ...
            <tr>
             ...
             <th><input name="short-attempt-ans-<%=j%>" type="hidden" value="<%= shorta.getAttemptedAns() %>"/>
             Attempted:  <%= shorta.getAttemptedAns() %></th>
			<th width="200"><input name="short-attempt-qid-<%=j%>" type="hidden" value="<%= shorta.getQuestionId() %>"/>
			<input name="short-attempt-version-<%=j%>" type="hidden" value="<%= shorta.getVersion() %>"/>
			
			<% System.out.println("Short mark read in"); System.out.println(shorta.getMark());%>
