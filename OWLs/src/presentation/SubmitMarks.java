	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (ShortAttempt shortAttempt: shortAttempts) {
			...
			if (currentVersion == databaseVersion) {
				...
				sbs.incrementShortVersion(subjectCode, year, semester, examType, shortQuestionIdTemp, studentId, currentVersion);
		...
		for (MultipleAttempt multipleAttempt: multipleAttempts) {
			...
			if (currentVersion == databaseVersion) {
				...
				sbs.incrementMultipleVersion(subjectCode, year, semester, examType, multipleQuestionIdTemp, studentId, currentVersion);
