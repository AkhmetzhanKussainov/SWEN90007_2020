...
INSERT INTO multipleAttempt
VALUES (2,'HIS101', '2020','2','F','S12','B',1,false);

--last boolean indicates whether its been marked
INSERT INTO multipleAttempt
VALUES (3,'HIS101', '2020','2','F','S12','C',3,false);

--last boolean indicates whether its been marked
INSERT INTO shortAttempt
VALUES (1,'HIS101', '2020','2','F','S12','I killed Lord Voldemort',0,true);

INSERT INTO shortAttempt
VALUES (2,'HIS101', '2020','2','F','S12','Ive done it and it is weird',1,true);

INSERT INTO shortAttempt
VALUES (3,'HIS101', '2020','2','F','S12','Dodgy shops',2,true);
...
--last boolean indicates whether its been marked (ignore), second last is mark
INSERT INTO multipleAttempt
VALUES (1,'HIS101', '2020','2','F','S13','C',0,false);

--last boolean indicates whether its been marked
INSERT INTO multipleAttempt
VALUES (2,'HIS101', '2020','2','F','S13','C',1,false);

--last boolean indicates whether its been marked
INSERT INTO multipleAttempt
VALUES (3,'HIS101', '2020','2','F','S13','C',3,false);

--last boolean indicates whether its been marked
INSERT INTO shortAttempt
VALUES (1,'HIS101', '2020','2','F','S13','Harry Potter killed Lord Voldemort',0,true);

INSERT INTO shortAttempt
VALUES (2,'HIS101', '2020','2','F','S13','Time Travel is impossible',1,true);

INSERT INTO shortAttempt
VALUES (3,'HIS101', '2020','2','F','S13','All manner of unscrupulous wizards and witches',2,true);
